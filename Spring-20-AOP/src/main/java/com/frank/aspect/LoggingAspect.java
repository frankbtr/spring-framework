...
//    @Pointcut("execution(* com.frank.controller.CourseController.*(..))")
...
//    @Before("execution(* com.frank.controller.CourseController.*(..))")
//    public void beforeAdvice(){
//        logger.info("Logger info ------");
//    }

//    @Pointcut("execution(* com.frank.repository.CourseRepository.findById(*))")
...
//    //within
//    @Pointcut("within(com.frank.controller..*)")
...
//    }
    ...
    @Pointcut("@annotation(com.frank.annotation.Loggable)")
