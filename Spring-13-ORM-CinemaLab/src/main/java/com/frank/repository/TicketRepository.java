...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    List<Ticket> findAllTicketsByDateTimeBetween(LocalDateTime dateTime1, LocalDateTime dateTime2);
    ...
    Integer countTicketByUserInDteRange(@Param("userId") Long userId, @Param("dateTime1") LocalDateTime dateTime1, @Param("dateTime2") LocalDateTime dateTime2);
    ...
    @Query(value = "SELECT * FROM ticekt t JOIN user_account ua ON t.user_accoubnt_id = ua.id" +
    ...
    //Write a native query to list all tickets where a specific value should be containable in the userName
