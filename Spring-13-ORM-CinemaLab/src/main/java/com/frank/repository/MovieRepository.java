...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    // ------------------- DERIVED QUERIES ------------------- //
    //Write a derived query to read movie with a name
    ...
    //Write a derived query that returns all movies name
    ...
    List<Movie> retrieveByPriceBetween(@Param("price1") BigDecimal price1,@Param("price2") BigDecimal price2);

    //Write a native query that return all movies where duration exists in the range of duration
    ...
    @Query(value = "SELECT * FROM movie WHERE price DESC LIMIT 5", nativeQuery = true)
